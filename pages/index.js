...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-100">
      <Head>
        <title>Login Ui -Next.js and Tailwind css</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <div className={`bg-white rounded-2xl shadow-2xl flex flex-row  w-2/3 max-w-4xl ${isLoading? 'animate-pulse':'animate-none'}`}>
          <div className="w-3/5 p-5">
            <div className="text-left font-bold"> <span className="text-blue-500">Company</span>Name</div>
            <div className="py-10">
              <h2 className="text-3xl font-bold text-blue-500">Sign in to Account</h2>
              <div className="border-2 w-20 inline-block border-blue-500 mb-2 rounded-2xl"></div>
              ...
              <div className="flex flex-col items-center">
                ...
                <a href="#" className="border-2 border-blue-500 text-blue-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-blue-500 hover:text-white">Sign In</a>
              </div>
          ...
          <div className="w-2/5  bg-blue-500 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12">
            ...
            <div className="border-2 w-20 inline-block border-white mb-2 rounded-2xl"></div>
